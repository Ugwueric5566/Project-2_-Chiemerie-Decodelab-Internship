...
This project focuses on analyzing and visualizing sales data using Google Sheets. The goal was to transform raw sales data into meaningful information that can help businesses understand their sales performance and make better data-driven decisions.

The project involved several stages, including data cleaning, data organization, analysis, calculation of key performance indicators (KPIs), and dashboard creation. Functions and features in Google Sheets were used to analyze important areas such as sales, transactions, products, payment methods, customer acquisition channels, order status, and sales trends over time.
...
Examine sales by payment method and acquisition channel.
Analyze order status and sales trends.
Calculate important KPIs and descriptive statistics.
